...
<CodePreviewTabs>
  <Fragment slot="tab-1-label">データ作成 (Create)</Fragment>
  ...
  <Fragment slot="tab-2-label">データ取得 (Read)</Fragment>
  ...
  <Fragment slot="tab-3-label">データ更新 (Update)</Fragment>
  <Fragment slot="tab-3-content">
  ```ts
  import prisma from '@/lib/prisma';
  ...
  <Fragment slot="tab-4-label">データ削除 (Delete)</Fragment>
  <Fragment slot="tab-4-content">
  ```ts
  import prisma from '@/lib/prisma';
