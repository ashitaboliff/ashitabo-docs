...
<CodePreviewTabs>
  <Fragment slot="tab-1-label">NavLink.tsx (改善例の骨子)</Fragment>
    ...
    return (
      <Link
        ...
        className={`
          ...
          ${
            isActive
              ? 'bg-sky-700 text-white shadow-inner' // アクティブ時のスタイル
      ...
      >
        ...
        <span
          className={`
            ...
            ${isActive ? 'bg-yellow-400 max-w-full' : 'bg-sky-500'}
          `}
